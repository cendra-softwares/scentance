...
export default function TermsAndConditions() {
  return (
    <div className="min-h-screen pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
      ...
      >
        <h1 className="text-4xl md:text-5xl font-serif text-white mb-12 border-b border-neutral-800 pb-4">Terms & Conditions</h1>
        
        <div className="space-y-10 text-neutral-300 leading-relaxed">
          <section className="space-y-4">
            <h2 className="text-2xl font-serif text-white italic">1. Acceptance of Terms</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-serif text-white italic">2. Product Information</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-serif text-white italic">3. Pricing and Payments</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-serif text-white italic">4. Intellectual Property</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-serif text-white italic">5. Limitation of Liability</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-serif text-white italic">6. Governing Law</h2>
            <p>
          ...
          <section className="space-y-4 border-t border-neutral-800 pt-8">
            <h2 className="text-2xl font-serif text-white italic">7. Contact Us</h2>
            <p>
